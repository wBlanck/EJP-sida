...
const AboutSection = () => {
  return (
    <div className="bg-[#1f1f1f] pt-24 relative lg:h-screen">
      ...
      <section className="flex items-center w-full h-full mx-auto">
        <div className="absolute left-0 bg-[#232323] h-[500px] w-4/5 -z-0"></div>
